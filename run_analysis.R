...
## ....../                         <- base folder. Contains run_analysis.R. This is also CWD
## ....../UCI HAR Dataset/         <- UCI HAR dataset directory. Contains activity_labels.txt, features.txt etc
...
## ---------------------------------------------------------------------
## step 1 - read training and test datasets and merge into single frame
## ---------------------------------------------------------------------
...
## merge training and test datasets to create a single dataframe
...
## ---------------------------------------------------------------------
## step 5 - create a new tidy data set with average value across Activity and Subject 
## ---------------------------------------------------------------------
...
write.table(tidyAvgData, file="tidyAvgData.txt", sep=",", row.names=FALSE)
